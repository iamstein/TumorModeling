...
compare.thy.sim = function(model = model, 
  ...
  df_sim = df_sim %>% mutate(param = param.to.change, param.to.change = param.to.change.range)
  ...
  df_thy = df_thy %>% mutate(param = param.to.change, param.to.change = param.to.change.range)
  
  # Arrange theory and simulation in single data frame.
  df_compare = bind_rows(df_thy,df_sim)
  df_compare = df_compare %>%
    mutate(param = param.to.change) %>%
