---
title: "Task05c_Sensitivity_Analysis_pt2"
...
# Initialize.
# --------------------------------------------------------------------------------
source("AFIRT_calculation_Vlink.R") #use one where all the valumes are linked to V1, V2, V3
...
parameters = c("dose", "ksynM3", "k13D","k13DM", "kshedDM3","V3")
...
g = g + scale.y.log10(limits=c(.0001,1))
g = g + geom_line()
...
plot(g)
ggsave("../results/Task05c_AFTIR.Kssd.pdf",width = width,height=height)
g = g %+% plots.T.Kssd
g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)")
plot(g)
ggsave("../results/Task05c_TFTIR.Kssd.pdf",width = width,height=height)

g = g %+% plots.A.Kss
g = g + labs(y="Average Free Tissue target to\nInitial target Ratio (AFTIR)")
plot(g)
ggsave("../results/Task05c_AFTIR.Kss.pdf",width = width,height=height)
g = g %+% plots.T.Kss
g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)")
plot(g)
ggsave("../results/Task05c_TFTIR.Kss.pdf",width = width,height=height)

g = g %+% plots.A.Kd
g = g + labs(y="Average Free Tissue target to\nInitial target Ratio (AFTIR)")
plot(g)
ggsave("../results/Task05c_AFTIR.Kd.pdf",width = width,height=height)
g = g %+% plots.T.Kd
g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)")
plot(g)
ggsave("../results/Task05c_TFTIR.Kd.pdf",width = width,height=height)
```
