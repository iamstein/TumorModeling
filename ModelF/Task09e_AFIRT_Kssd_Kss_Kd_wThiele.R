...
width = 10
height = 6
ggsave("../results/Task09e_AFTIR_Kssd_Kss_Kd_wThiele.pdf",width = width,height=height)
...
print(g)
ggsave("../results/Task09e_TFTIR_Kssd_Kss_Kd_wThiele.pdf",width = width,height=height)
