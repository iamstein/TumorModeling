...
Note: This function computes AFIRT as the average of M3/M3.0 when time \in (56, 84).
```{r}
...
Argument: 
    ...
    variable: the name of the variable you want to vary, e.g. kshedM3, kon3, koff3 etc
    range: the range of the variable, typically the return of lseq function
Return:
...
Basically, it puts the data frame returned from sensitivity_analysis_for_AFIRT onto a picture
```{r}
