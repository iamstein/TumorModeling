...
width = 10
height = 6
ggsave("../results/Task09d_AFTIR_vs_AFTIRsimple_wThiele.pdf",width = width,height=height)
...
print(g)
ggsave("../results/Task09d_TFTIR_vs_TFTIRsimple_wThiele.pdf",width = width,height=height)
