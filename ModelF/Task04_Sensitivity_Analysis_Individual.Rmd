...
param.to.change.range = lseq(as.numeric(df_param[param.to.change])*.01, as.numeric(df_param[param.to.change])*100, 7)
...
# Plot.
ggplot(df_sim, aes(x=fold.change.param, y=fold.change.AFIRT.sim)) + 
  geom_line() + 
  geom_point() +
  scale.x.log10() +
  # scale.y.log10() +
  scale.y.log10(limits=c(10^-2, 10^2)) +
