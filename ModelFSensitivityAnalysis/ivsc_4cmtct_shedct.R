...
ivsc_4cmtct_shedct = function() {
  ...
  model$pin       = c('F','ka','VD1','VD2','VD3','VS1','VS3','VDS1','VDS3',
                      ...
                      'kon1','koff1','kon3','koff3','k13DM', 'k31DM',
  ...
  model$rxode.str = '
     ...
     d/dt(DM3)    = -kshedDM3*DM3  - keDM3*DM3 + kon3*D3*M3      - koff3*DM3 - k13DM*DM3 + k31DM*VD1/VD3*DM1;
     d/dt(DM1)    = -keDM1*DM1 -kshedDM1*DM1 +kon1*D1*M1 -koff1*DM1 - k31DM*DM1 + k13DM*VD3/VD1*DM3;
