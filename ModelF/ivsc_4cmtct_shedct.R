ivsc_4cmtct_shedct = function() {
  ...
  D1           = AmtD1/VD1;
  d/dt(AmtD0)  =  -ka *AmtD0;
  d/dt(AmtD1)  =(F*ka *AmtD0/VD1 - k12D*D1 + k21D*VD2/VD1*D2)*VD1 - k13D *D1 +  k31D *VD3 /VD1* D3    - kon1*D1*(S1+M1) + koff1*(DS1+DM1) - keD1 *D1;
  ...
  d/dt(M1)     = ksynM1 - kshedM1*M1                              - k13M *M1  + k31M *VD3 /VD1* M3    - kon1*D1*M1      + koff1*DM1       - keM1 *M1 ;
  d/dt(M3)     = ksynM3 - kshedM3*M3                              - k31M *M3  + k13M *VD1 /VD3* M1    - kon3*D3*M3      + koff3*DM3       - keM3 *M3;
  ...
  d/dt(DM1)    =        - kshedDM1*DM1                            - k13DM*DM1 + k31DM*VD3 /VD1* DM3   + kon1*D1*M1      - koff1*DM1       - keDM1*DM1;
  d/dt(DM3)    =        - kshedDM3*DM3                            - k31DM*DM3 + k13DM*VD1 /VD3* DM1   + kon3*D3*M3      - koff3*DM3       - keDM3*DM3;
  '
