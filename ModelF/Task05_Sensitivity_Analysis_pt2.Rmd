...
for (i in 1:length(drugs)){
  ...
  if (drugs[i] %in% soluble) {parameters["ksynM3"] = "ksynS3"}
  ...
  if (all(df_param[parameters[2:6]] != 0)){
    params.to.iterate = data.frame(lseq(scale.mpk2nmol*.1,scale.mpk2nmol*10,7),
    ...
    # Like I said above kshedM3 and kshedDM3 are skipped for Herceptin.
