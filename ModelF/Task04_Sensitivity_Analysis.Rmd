...
# ksynS3.range    = lseq(df_param$ksynM3  *.1, df_param$ksynM3  *10, 7)
# kshedS3.range   = lseq(df_param$kshedM3 *.1, df_param$kshedM3 *10, 7)
# kshedDS3.range  = lseq(df_param$kshedDM3*.1, df_param$kshedDM3*10, 7)
